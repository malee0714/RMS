...
public class CheckMVo {
	...
	/* RS_WRHSDLVR 테이블 */
	private String wrhsdlvrSeCode;            /* ZRS08_입출고 구분 코드 */
	private String wrhsdlvrDeptCode;            /* 입출고 부서 코드 */
	private String wrhsdlvrmanId;            /* 입출고자 ID */
	private String wrhsdlvrDte;            /* 입출고 일자 */
	private String wrhsdlvrQy;            /* 입출고 량 */
	private String brcdCreatAt;            /* 바코드 생성 여부 */
	private String validDte;            /* 유효 일자 */
	private String cntnrQy;            /* 용기 량 */

	/* RS_PRDUCT_BRCD 테이블 */
	private String brcdSeqno;            /* 바코드 일련번호 */
	private String brcd;            /* 바코드 */
	private String outptCnt;            /* 출력 카운트 */
	...
	private String countBrcd;
	private String qtt;
	private String resetWrhs;
	private String resetQtt;
	private String getBacode;
	private String requstDeptCodeSch;
